export const TestimonialComponent = () => {
    return (
      <section className="flex items-center justify-center py-20 bg-background min-w-screen">
          <div className="px-16 bg-background">
            <div className="container flex flex-col items-start mx-auto lg:items-center">
              ...
              <h2 className="relative flex items-start justify-start w-full max-w-3xl text-5xl font-bold lg:justify-center">
                <svg
                  ...
                  fill="currentColor"
                  className="absolute right-0 hidden w-12 h-12 -mt-2 -mr-16 text-muted/30 lg:inline-block"
              ...
              <div className="items-center justify-center w-full mt-12 mb-4 lg:flex">
                <div className="flex flex-col items-start justify-start w-full h-auto mb-12 lg:w-1/3 lg:mb-0">
                  <div className="flex items-center justify-center">
                    <div className="w-16 h-16 mr-4 overflow-hidden bg-muted rounded-full">
                      <img alt="image"
                    ...
                    <div className="flex flex-col items-start justify-center">
                      ...
                      <p className="text-muted-foreground">CEO of Something</p>
                    </div>
                  </div>
                ...
                <div className="flex flex-col items-start justify-start w-full h-auto px-0 mx-0 mb-12 border-l border-r border-transparent lg:w-1/3 lg:mb-0 lg:px-8 lg:mx-8 lg:border-border">
                  <div className="flex items-center justify-center">
                    <div className="w-16 h-16 mr-4 overflow-hidden bg-muted rounded-full">
                      <img alt="image"
                    ...
                    <div className="flex flex-col items-start justify-center">
                      ...
                      <p className="text-muted-foreground">CTO of Business</p>
                    </div>
                  </div>
                  <blockquote className="mt-8 text-lg text-muted-foreground">
                ...
                <div className="flex flex-col items-start justify-start w-full h-auto lg:w-1/3">
                  <div className="flex items-center justify-center">
                    ...
                    <div className="flex flex-col items-start justify-center">
                      ...
                      <p className="text-muted-foreground">Creator of Stuff</p>
                    </div>
                  </div>
                  <blockquote className="mt-8 text-lg text-muted-foreground">
